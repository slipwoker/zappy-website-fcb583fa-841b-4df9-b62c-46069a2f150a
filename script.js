    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "י.ז.ן עבדות מסגרות בעם משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'fcb583fa-841b-4df9-b62c-46069a2f150a',
                    name: data.name || '',
                    email: data.email || '',
